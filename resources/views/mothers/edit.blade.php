                ...
                <form method="POST" action="{{ route('mothers.update', $mother) }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 text-gray-800">
                                {{ $mother->hospital_number }}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="marital_status"
                                ...
                                <option value="Single" {{ old('marital_status', $mother->marital_status) == 'Single' ? 'selected' : '' }}>
                                    Single
                                </option>
                                <option value="Married" {{ old('marital_status', $mother->marital_status) == 'Married' ? 'selected' : '' }}>
                                    Married
                                </option>
                                <option value="Separated" {{ old('marital_status', $mother->marital_status) == 'Separated' ? 'selected' : '' }}>
                                    Separated
                                </option>
                                <option value="Widowed" {{ old('marital_status', $mother->marital_status) == 'Widowed' ? 'selected' : '' }}>
                                    Widowed
                                </option>
                            </select>
